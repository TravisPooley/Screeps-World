...
function routeCallback(roomName, fromRoomName) {
    ...
    if(room && room.controller && room.controller.reservation && room.controller.reservation.username === USERNAME) return ROUTE_MY_ROOM_COST;

    if(room && room.controller && (room.controller.reservation || room.controller.owner && room.controller.owner.username !== USERNAME)) return ROUTE_HOSTILE_ROOM_COST;
