module.exports = {
    ...
    calculateCostOfaMine(distance, swampCount, mineCapacity) {
        ...
        return {
            distance: distance,
            potentialEnergy: energy_generated,
            carry: {
                cost: carry_cost,
                carryNeeded: carry_needed,
                carryMoveNeeded: carry_move_needed,
                travelTime: carry_travel_time,
            },
            miner: {
                cost: miner_cost,
                workNeeded: work_needed,
                workMoveNeeded: work_move_needed,
                travelTime: miner_travel_time,
            },
